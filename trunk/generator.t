...
*   последняя модификация 27.07.08
...
['2U'	'ьи'   'ьёв'   'ьям'   'ьи'   'ьями'   'ьях']   // -воробьИ, муравьИ
['2F'	'ьи'   'ей'   'ьям'   'ьи'   'ьями'   'ьях']
['2M'	'ьи'   'ьев'   'ьям'   'ьи'   'ьями'   'ьях']   //ульи
['2F'	'йки'   'ек'   'йкам'   'йки' 'йками'   'йках']
['2F'	'(4)ки' '$1ек'   '$1кам'   '$1ки' '$1ками'   '$1ках']  // (4 - шипящие)

['2'	'(8)и'   '$1ев'   '$1ям'   '$1и'   '$1ями'   '$1ях']  // 8 - гл-ые 
['2'	'(4)и'   '$1ей'   '$1ам'   '$1и'   '$1ами'   '$1ах']
['2'	'(0)и'   '$1ей'   '$1ям'   '$1и'   '$1ями'   '$1ях']

['2'	'и'   'ей'   'ам'   'ей'   'ами'   'ах']   //гжкх
[''	'и'   'и'   'и'   'и'   'и'   'и']
['2'	'ы'   'ов'   'ам'   'ы'   'ами'   'ах']
[''	'ы'   'ы'   'ы'   ''   'ы'   'ы'   'ы']
]
...
[''	'(8[бвгджзйкмнпрстфхцчшщ])ец' '$1ца' '$1цу' '$1ец' '$1цом' '$1це'] //резец, ловец, но не жнец
// заяц - ?
...
start(...) =
{
 ...
 Перед \"/\" -  учтенные свойства объекта. (-) - повтор. (#d)(#t) - добавлены лексемы с метками падежей. \b";
    ...
    while (obj <> nil)
    {
      ...
      // СКЛОНЯЕМ КОРОТКИЕ ОПИСАНИЯ (GDESC)
      sdescstr:=obj.gdesc;
...
// (от 0 до 7; 7 - альтернативный творительный), часть речи (1 - существительное 
// , 2 - прилагательное) [опционально, 1 - по умолчанию], бинарный флаг (возвращать ли
// информацию о граматических свойствах слова)[опционально]  
generate: function(obj, str, sklonenie, ...)
{
  ...
  if (str)
  {
    ...
    // TODO: ключ проверки необходимости преобразовывать строку
    if (find(info, 'u')<>nil) 
      str:=loweru(str);
  }
